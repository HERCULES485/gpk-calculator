...
// нет вовсе — восемь простых узлов (включая два узла kind: 'event' —
// ст. 223.6 п. 1 и ст. 223.2 п. 6) имеют восемь независимых якорей и не
// делят между собой ни одного поля. При строгом критерии «общий якорь»
// ветвей было бы десять по одному-двум узлам, и переключатель перестал бы
// что-либо объяснять.
