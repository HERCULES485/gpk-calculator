...
// нет вовсе — шесть простых узлов имеют шесть независимых якорей и не делят
// между собой ни одного поля. При строгом критерии «общий якорь» ветвей было бы
// восемь по одному-двум узлам, и переключатель перестал бы что-либо объяснять.
