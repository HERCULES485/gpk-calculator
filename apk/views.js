...
const NODE_REQUIREMENTS = {
  ...
  // Узел-событие (ч. 3 ст. 229): без собственного дискриминатора, то же поле
  // якоря, что и у simplified_proceedings_appeal_apk выше.
  simplified_proceedings_entry_into_force_apk: {
    node: SIMPLIFIED_PROCEEDINGS_ENTRY_INTO_FORCE_APK,
    kind: 'event',
    deps: () => ['simplified_proceedings_decision_date'],
    compute: (i) => computeSimplifiedProceedingsEntryIntoForceApk(i),
  },
  ...
  // Без restoration-узла: ч. 4 ст. 198 предусматривает восстановление без
  ...
  claim_refusal_appeal_apk: {
    node: CLAIM_REFUSAL_APPEAL_APK,
    deps: () => ['claim_refusal_ruling_date_apk'],
    compute: (i) => computeClaimRefusalAppealApk(i),
  },
  deadline_restoration_refusal_appeal_apk: {
    node: DEADLINE_RESTORATION_REFUSAL_APPEAL_APK,
    deps: () => ['deadline_restoration_refusal_ruling_date_apk'],
    compute: (i) => computeDeadlineRestorationRefusalAppealApk(i),
  },
  deadline_extension_refusal_appeal_apk: {
    node: DEADLINE_EXTENSION_REFUSAL_APPEAL_APK,
    deps: () => ['deadline_extension_refusal_ruling_date_apk'],
    compute: (i) => computeDeadlineExtensionRefusalAppealApk(i),
  },
  decision_clarification_ruling_appeal_apk: {
    node: DECISION_CLARIFICATION_RULING_APPEAL_APK,
    deps: () => ['decision_clarification_ruling_date_apk'],
    compute: (i) => computeDecisionClarificationRulingAppealApk(i),
  },
  enforcement_restoration_ruling_appeal_apk: {
