...
test('утверждение мирового соглашения уходит в .ics (1 месяц → напоминания за 3 и 7 дней)', () => {
  const view = buildView(
...
test('утверждение мирового соглашения: тот же срок и через icsTermsFromChain', () => {
  const chain = computeChain(
