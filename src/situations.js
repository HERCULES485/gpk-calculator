...
export const SITUATIONS = [
  ...
  {
    id: 'adoption',
    label: 'Усыновление (удочерение) ребёнка',
    // Глава 29 ГПК: отдельная категория дел со своим сроком апелляции — 10
    // дней вместо месяца общего порядка (ч. 2.1 ст. 274). Своя ситуация, а не
    // модификация общей цепочки, по той же логике, что и child_return; здесь
    // всего одно поле и один узел, а не два, потому что раскрыт только срок
    // на апелляцию, а не вся процедура главы 29.
    fields: ['adoption_reasoned_decision_date'],
    nodes: ['adoption_appeal'],
  },
  {
    id: 'separate',
