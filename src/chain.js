...
export const SETTLEMENT_APPROVAL_CASSATION_APPEAL = {
  ...
  logic:
    ...
    'соглашения (ч. 11 ст. 153.10 ГПК РФ) — нормой охватывается утверждение ' +
    'любого мирового соглашения, на любой стадии процесса и в любой ' +
    'инстанции, включая (но не ограничиваясь) утверждение в процессе ' +
    'исполнения судебного акта. Обжалуется сразу в суд кассационной ' +
    'инстанции, минуя апелляцию: определение об утверждении мирового ' +
    'соглашения — акт, для которого апелляционное обжалование не ' +
    'предусмотрено (п. 3 ПП ВС РФ от 22.06.2021 № 17). Определение подлежит ' +
